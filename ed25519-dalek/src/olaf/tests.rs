        ...
        fn test_invalid_number_of_messages() {
            ...
            match result {
                ...
                Err(e) => match e {
                    ...
                    _ => {
                        panic!(
                            "Expected DKGError::InvalidNumberOfMessages, but got {:?}",
                            e
                        )
                    }
                },
        ...
        fn test_different_recipients_hash() {
            ...
            match result {
                ...
                Err(e) => match e {
                    ...
                    _ => {
                        panic!(
                            "Expected DKGError::DifferentRecipientsHash, but got {:?}",
                            e
                        )
                    }
                },
        ...
        fn test_invalid_participants() {
            ...
            match result {
                ...
                Err(e) => match e {
                    ...
                    _ => {
                        panic!(
                            "Expected DKGError::InvalidNumberOfParticipants, but got {:?}",
                            e
                        )
                    }
                },
